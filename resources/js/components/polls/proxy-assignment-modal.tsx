        ...
        <Dialog open={isOpen} onOpenChange={(open) => !open && handleClose()}>
            <DialogContent className="sm:max-w-3xl">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Select a user who cannot vote (Principal) and designate
                        someone to vote on their behalf (Proxy).
                    </DialogDescription>
                </DialogHeader>
                ...
                <div className="grid grid-cols-1 gap-6 py-4 md:grid-cols-2">
                    ...
                    <div className="space-y-3">
                        <div className="rounded-lg border bg-muted/30 p-3">
                            <h4 className="mb-2 text-sm font-medium text-muted-foreground">
                                1. Select Principal (Original Voter)
                            </h4>
                            {selectedPrincipal ? (
                                ...
                                <div className="flex h-14 items-center justify-center rounded border border-dashed text-xs text-muted-foreground">
                                    No user selected
                                </div>
                            )}
                        </div>
                    ...
                    <div className="space-y-3">
                        <div className="rounded-lg border bg-muted/30 p-3">
                            <h4 className="mb-2 text-sm font-medium text-muted-foreground">
                                2. Select Proxy (Designated Voter)
                            </h4>
                            {selectedProxy ? (
                                <div className="flex items-center justify-between rounded border bg-background p-2">
                                    <div className="flex items-center gap-2 overflow-hidden">
