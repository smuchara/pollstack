            ...
            */}
            <div className="relative flex min-h-screen flex-col overflow-hidden bg-background text-foreground transition-colors duration-300 selection:bg-primary/20 selection:text-primary">
                ...
                <div className="pointer-events-none absolute inset-0 -z-10">
                    ...
                    <div className="absolute -top-32 -left-32 h-96 w-96 rounded-full bg-primary/5 blur-3xl dark:bg-primary/10" />
                    <div className="absolute right-0 bottom-0 h-96 w-96 rounded-full bg-purple-500/5 blur-3xl dark:bg-purple-600/10" />
                ...
                {/* Hero Section */}
                <main className="mx-auto flex w-full max-w-6xl flex-1 flex-col px-6 pt-10 pb-16 lg:flex-row lg:items-center lg:gap-20 lg:px-8 lg:pt-12 lg:pb-24">
                    {/* Left: Copy */}
                    <section className="relative z-10 mb-12 max-w-2xl lg:mb-0 lg:flex-1">
                        <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-emerald-500/20 bg-emerald-500/10 px-3 py-1 text-[11px] font-medium tracking-widest text-emerald-600 uppercase dark:text-emerald-400">
                        ...
                        <h1 className="mb-6 text-4xl font-bold tracking-tight text-foreground sm:text-5xl lg:text-6xl lg:leading-[1.1]">
                            ...
                            <span className="animate-gradient bg-gradient-to-r from-primary via-purple-500 to-primary bg-[length:200%_auto] bg-clip-text text-transparent">
                                Decentralized Governance
                            </span>
                        </h1>

                        <p className="mb-8 max-w-lg text-base leading-relaxed text-muted-foreground sm:text-lg">
                            Launch organization-wide votes in seconds. Verify
                            every ballot on-chain. Watch results update in
                            real-time. Secure, transparent, and built for modern
                            teams.
                        </p>
                    ...
                    <section className="relative z-10 w-full max-w-md lg:flex-1">
                        ...
                        {/* The Card Container */}
                        <div className="relative rounded-[2rem] border border-border/50 bg-background/50 p-2 shadow-2xl ring-1 ring-white/20 backdrop-blur-xl dark:bg-card/40 dark:ring-white/5">
                                ...
                                <div className="mt-6 flex items-center justify-between border-t border-border pt-4">
                                    <div className="flex -space-x-2">
                                        {[1, 2, 3].map((i) => (
                                            <div
                                                key={i}
                                                className="flex h-6 w-6 items-center justify-center rounded-full border-2 border-card bg-muted text-[8px] text-muted-foreground"
                                            >
                                                U{i}
                                            </div>
                                        ))}
