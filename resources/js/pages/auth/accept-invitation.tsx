...
import { Mail, User, Lock, CheckCircle2, Clock } from 'lucide-react';
          ...
          <div className="flex-1 space-y-2">
            <div>
              ...
              <p className="text-xs text-blue-700 dark:text-blue-300 mt-1">
                Create your account to join as a <span className="font-semibold capitalize">{invitation.role}</span>
              </p>
            </div>
            <div className="flex items-center gap-2 text-xs text-blue-600 dark:text-blue-400">
              <Clock className="h-3 w-3" />
              <span>Expires in {timeRemaining} {timeRemaining === 1 ? 'day' : 'days'}</span>
            </div>
          </div>
        </div>
      </div>
